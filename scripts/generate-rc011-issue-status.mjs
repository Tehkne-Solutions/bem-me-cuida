...
const lines = [
  ...
  '### OTA', '', `- Publicação de validação: ${statusIcon(ota.publish.status)} \`${ota.publish.status}\``, `- Rollback: ${statusIcon(ota.rollback.status)} \`${ota.rollback.status}\``, `- Runtime: \`${ota.runtimeVersion}\``, `- Canal: \`${ota.channel}\``, '',
