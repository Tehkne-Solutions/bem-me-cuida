...
import { createAndroidHomologationPlan } from './lib/rc011-android-artifact.mjs';
...
const plan = createAndroidHomologationPlan({
  ...
  deviceMatrix: readJson(args.devices),
...
console.log(`Plano Android pendente de homologação criado em ${output}.`);
console.log('Nenhum aparelho ou suíte foi marcado como aprovado.');
